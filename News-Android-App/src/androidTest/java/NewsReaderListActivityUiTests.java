...
public class NewsReaderListActivityUiTests
    ...
    public void testPositionAfterOrientationChange_sameActivity() {
        ...
        onView(withId(R.id.list)).check(new RecyclerViewAssertions(mPosition - 3));
    ...
    public void testPositionAfterActivityRestart_sameActivity() {
        NewsReaderDetailFragment ndf = (NewsReaderDetailFragment) waitForFragment(R.id.content_frame, 10000);
